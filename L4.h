...
public:
     ...
     */
    l4_packet(const std::string& packet);
...
private:
    /**
     * @brief Checks if communication exists between ports
     * @param open_ports Vector of open ports
     * @param src_port Source port
     * @param dst_port Destination port
     * @return true if communication exists
     */
    bool communication_exists(const open_port_vec& open_ports, uint16_t src_port, uint16_t dst_port);
};
